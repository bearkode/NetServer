...
- (BKEvent *)detectStandbyEvent
{
    ...
    [self enumerateFramesUsingBlock:^(BKFrame *aHand, BOOL *aStop) {
        ...
        double sDeltaX   = fabs([sLastPosition x] - [sPosition x]);
        double sDeltaY   = fabs([sLastPosition y] - [sPosition y]);
        double sDeltaZ   = fabs([sLastPosition z] - [sPosition z]);
        double sCritical = 10.0;
